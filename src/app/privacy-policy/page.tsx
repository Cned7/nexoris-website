    ...
    <main className="mx-6 lg:mx-12 mt-23 lg:mt-32 xl:mx-21">
      ...
      <section className="space-y-8 text-text container mx-auto">
        <p className="text-text font-body">
          ...
          controller of your personal data. This Privacy Policy outlines how we
          collect, process, and protect your personal information when you visit
          our website. By using our website, you agree to the terms set forth in
          this policy.
        </p>
        ...
        <p className="text-text font-body">
          When you visit the <strong>NEXORIS Technologies Ltd</strong> website,
          we automatically collect certain information about your device,
          including information about your web browser, IP address, time zone,
          and some of the installed cookies on your device. Additionally, as you
          browse the website, we collect information about the individual web
          pages or products you view, what websites or search terms referred you
          to the website, and how you interact with the website. We refer to
          this automatically collected information as &quot;Device
          Information.&quot;
          <br /> <br />
          Moreover, we might collect the personal data you provide to us
          (including but not limited to name, email, phone number, request type,
          messages, etc.) during project request form submissions and contact
          form submissions to be able to fulfill the agreement.
        </p>
        ...
        <div className="-mt-4">
          ...
          <p className="my-4">
            ...
            listed above. Additionally, please note that your information might
            be transferred outside of Europe, including Canada and the United
            States.
          </p>
        </div>
        ...
        <p>
          ...
          protect it from unauthorized access, use, disclosure, and loss. We
          regularly review and update these measures to ensure that we maintain
        ...
        <ul className="list-disc pl-5 font-body text-text -mt-4">
          <li>
            ...
            technologies to protect the transmission of personal information
            between your device and our servers.
          </li>
          <li>
            <strong>Access Control:</strong>We restrict access to personal
            information to only those employees, contractors, and agents who
            need it to perform their work and are bound by confidentiality
            obligations.
          </li>
          <li>
            <strong>Regular Security Audits:</strong>We perform regular security
            audits to identify and address potential vulnerabilities in our
            systems.
          </li>
        </ul>
        <p className="-mt-3">
          Despite these efforts, no security measures are perfect, and we cannot
          guarantee that your personal information will never be accessed, used,
          disclosed, or lost. If you become aware of any security incidents,
        ...
        <div className="text-text font-body">
          ...
          <p>
            We are committed to retaining your personal data only for as long as
            necessary to fulfill the purposes outlined in this Privacy Policy,
            unless a longer retention period is required or permitted by law.
            The retention period for personal data may vary depending on the
            type of data and the purposes for which it was collected.
          </p>
          <p className="my-4">
            Generally, we will retain your personal data for the duration of
            your relationship with us and for a reasonable period thereafter to
            comply with legal obligations, resolve disputes, and enforce our
            agreements. Once the personal data is no longer necessary for the
          ...
          <p>
            ...
            requirements. We regularly review our retention practices to ensure
            that we only retain personal data for as long as necessary to
