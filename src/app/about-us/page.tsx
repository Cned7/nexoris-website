...
const organizationSchema = {
  ...
  url: 'https://nexoristech.com/about-us',
  logo: 'https://nexoristech.com/images/logo.webp',
  description:
    'Learn about Nexoris Technologies Ltd, our mission to empower businesses with innovative and secure technology solutions, and our core values driving our work.',
  address: {
    '@type': 'PostalAddress',
    streetAddress: 'Badore, Ajah',
  ...
  contactPoint: {
    '@type': 'ContactPoint',
    telephone: '+234703123456',
    contactType: 'customer service',
    email: 'info@nexoristech.com',
  },
  sameAs: [
    'https://www.linkedin.com/company/nexoris-technologies',
    'https://twitter.com/nexoris',
  ],
}
...
export default function AboutUsPage() {
  ...
  return (
    <>
      <Head>
        {/* Prevent indexing of this page - Remove this if you want it indexed */}
        {/* <meta name="robots" content="noindex, nofollow" /> */}
        <title>About Us - Nexoris Technologies</title>{' '}
        {/* Add a relevant title */}
        <meta
          name="description"
          content="Learn more about Nexoris Technologies and our team." // Add a relevant description
        />
      ...
      <main className="mx-4 md:mx-6 lg:mx-12 mt-20 lg:mt-28 xl:mx-21">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="w-full">
              ...
              <p className="mb-4 text-justify text-body">
                ...
                company—we&apos;re a group of dreamers, doers, and
                problem-solvers who believe in the power of technology to make
                the world a better place. We&apos;re here to help businesses
                grow and evolve, bringing innovative ideas and solutions to
                life, all while fostering a sense of trust and collaboration
              ...
              <p className="text-justify text-body">
                ...
                passionate experts dedicated to delivering solutions that not
                only meet our clients&apos; needs but exceed their expectations.
                Whether you&apos;re just starting your journey or looking to
                take your business to the next level, we&apos;re here to help
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-center text-secondary-background">
            <div className="bg-heading p-6 rounded-xl shadow-md">
              ...
              <p className="text-base font-body">
                ...
                innovative, secure, and scalable technology solutions that make
                a real difference. We&apos;re here to help you thrive in the
                digital age, building strong foundations for your success.
              </p>
            </div>
            <div className="bg-heading p-6 rounded-xl shadow-md">
        ...
        <section className="px-4 py-10 sm:px-6 lg:px-20 container mx-auto bg-secondary-background rounded-lg">
          ...
          <ul className="list-disc pl-6 space-y-3 max-w-3xl mx-auto text-left text-lg text-body">
            <li>
              ...
              exploring new ideas and pushing boundaries to create solutions
              that matter.
            </li>
            <li>
            ...
            <li>
              <strong>Commitment to Excellence:</strong> We care deeply about
              the quality of our work, and we go the extra mile to ensure that
              our solutions are top-notch.
            </li>
            <li>
        ...
        <section className="px-4 py-10 sm:px-6 lg:px-20 my-10 bg-heading text-secondary-text rounded-lg w-full">
          ...
          <p className="mb-4 text-justify font-body text-base">
            ...
            cutting-edge cloud solutions, each designed to make your business
            more agile, secure, and future-ready.
          </p>
        ...
        <section className="px-4 py-10 sm:px-6 lg:px-20 container mx-auto w-full bg-secondary-background text-body">
          ...
          <p className="mb-4 text-justify">
            From our early days as a small startup, we&apos;ve always believed
            in the power of technology to change the world. Today, we stand
            proud of what we&apos;ve accomplished, but our story is just
            beginning. We’re not just a company—we’re a movement, committed to
            helping businesses like yours adapt, grow, and succeed in an
            ever-evolving world.
          </p>
